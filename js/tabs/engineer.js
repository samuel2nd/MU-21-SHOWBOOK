...
const EngineerTab = (() => {
    ...
    switcherOuts: {
      ...
      columns: [
        ['PGM A', 'CLEAN', 'PRESET', 'SWRPVW',
         ...
         'AUX 01', 'AUX 02', 'AUX 03', 'AUX 04'],
        ['AUX 05', 'AUX 06', 'AUX 07', 'AUX 08', 'AUX 09', 'AUX 10', 'AUX 11', 'AUX 12',
  ...
  function getUmdForPosition(position) {
    ...
    // Names must match RTR I/O naming (SWRPVW, AUX 01, IS 01, etc.)
